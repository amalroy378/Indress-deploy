...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0007_banner'),
        ('eachcategorypages', '0004_proimage_delete_productimage'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='userprofile.account'),
        ),
    ]
